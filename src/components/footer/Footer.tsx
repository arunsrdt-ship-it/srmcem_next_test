...
import logosrmcem from "../../assets/images/header/Updatedsrmcemlogo.png";
import Classes from "../../utils/styles/Global.module.css";
import { Link } from "react-router-dom";
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaPhone, FaTwitter } from "react-icons/fa";

import { MdEmail, MdLocationPin } from "react-icons/md";
import anti_sexual from "../../assets/pdf/ragging/Gendar Senstization and Sexual Harassment -ICC.pdf";
import mandatoryDiscloserPdf from "../../assets/pdf/Mandatory Disclosure-SRMCEM - 2023-24.pdf";
          ...
          <div className="w-full manage_footer_column ">
            <div className="w-fullspace-y-4 flex flex-col grid-first">
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="flex flex-col gap-1 ">
                  <div className="flex items-center gap-x-2">
                    <span>
                      <Link to="tel:7570003074" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                        <FaPhone />
                      </Link>
                    </span>
                ...
                <div className="flex gap-1 flex-col">
                  <div className="flex items-center gap-x-2">
                    <span className="text-[1.2rem]">
                      <Link to="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=admissions@srmcem.ac.in" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                        <MdEmail />
                      </Link>
                    </span>
                  ...
                  <p>
                    <Link to={`mailto:${footerData.contact.email}`} className=" text-[14px]">
              ...
              <div className="flex space-x-2 mt-4">
                <Link
                  to="https://www.facebook.com/SRMCEMOFFICIAL"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <Link
                  to="https://www.instagram.com/srmcem_official/"
                  target="_blank"
                  className="border rounded-full text-sm sm:text-base p-1  w-6 sm:w-8 h-6 sm:h-8 flex items-center justify-center transition-all duration-300 hover:rotate-[360deg] hover:border-[#ffb703] hover:bg-transparent hover:text-[#ffb703] cursor-pointer"
                ...
                <Link
                  to="https://www.linkedin.com/school/shri-ramswaroop-memorial-college-of-engineering-and-management-lucknow/"
                  target="_blank"
                  className="border rounded-full text-sm sm:text-base p-1 p-1  w-6 sm:w-8 h-6 sm:h-8 flex items-center justify-center transition-all duration-300 hover:rotate-[360deg] hover:border-[#ffb703] hover:bg-transparent hover:text-[#ffb703] cursor-pointer"
                  aria-label="LinkedIn"
                >
                  ...
                  <li key={index}>
                    <div className="flex items-center group hover:text-[#ffb703] ">
                      {link.title === "Mandatory Disclosure" || link.title === "Anti-Sexual Harassment - IIC" ? (
                        ...
                        <Link to={link.path} className=" text-[14px] text-white group-hover:text-[#ffb703]">
                          {link.title}
                        </Link>
                      )}
                    </div>
