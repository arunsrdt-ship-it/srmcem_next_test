...
import nirf from "../../assets/pdf/nirf/NIRF-2026.pdf"
          ...
          <div className="left-part flex items-center">
            <div>
              <ul className="flex items-center text-[13px] flex-row gap-2 ">
                ...
                <Link to="/uptac-2025" className="uppercase blink_uptac text-black font-semibold px-4 pt-1.5 pb-1 rounded-full flex items-center justify-center">UPTAC-2025</Link>
                <a
                  href={nirf}
                  target="_blank"
          ...
          <div className="right-part flex gap-3 items-center">
            <div className="flex gap-2 items-center">
              <ul className="flex text-black">
                ...
                <Link to="enquiry-form" className="bg-[#FFB703] px-2 font-bold border-2 border-[#ffb703]   flex gapx-x-1 items-center">
                  Apply Now 2026
                </Link>
              </ul>
            </div>
        ...
        <div className="flex lg:hidden justify-between">
          ...
          <div className="left-part flex items-center">
            <div>
              <ul className="flex items-center text-[11px] sm:text-[13px] flex-row gap-1 text-black">
                ...
                <Link to="/career">CAREER |</Link>
                <Link to="/uptac-2025" className="uppercase blink_uptac text-black font-semibold px-2 pt-1.5 pb-1 rounded-full flex items-center justify-center">UPTAC-2025</Link>
              </ul>
            </div>
          </div>
          <div className="right-part flex items-center">
            <div className="flex gap-1">
              ...
              <Link to="enquiry-form" className="bg-[#FFB703] px-1 group relative text-white lg:text-black font-semibold border-2 border-[#ffb703] text-[12px]  sm:text-sm flex gapx-x-1 items-center">
