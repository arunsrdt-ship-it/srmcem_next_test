            ...
            <div className="flex flex-row gap-2 w-full lg:w-[30%] justify-between  lg:justify-end">
              {
                ...
                </a> : <Link to={course.path} className="bg-[#233E6F] hover:bg-[#ffb703] text-white px-4 py-2 text-sm rounded flex items-center gap-2">
                  View Details <FaArrowRightLong />
                </Link>
              }

              <Link to="/enquiry-form" className="bg-[#ffb703] hover:bg-[#233E6F] text-white px-4 py-2 text-sm rounded inline-flex items-center gap-2">
