...
const WoodedCampusAll: React.FC = () => {
  return (
    <div className={`${Classes["container"]} py-7 md:py-10 lg:py-14`}>
      ...
      <div className="abhivyakti_grid_all mt-10">
        {WoodImages.map((item) => (
          <div key={item.id} className="border border-gray-200 p-3 rounded-md hover:border-[#ffb703] transition-all duration-200">
...
export default WoodedCampusAll;
